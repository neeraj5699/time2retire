...
sidebarLayout(position="right",
	sidebarPanel(
		...
		helpText("Idea and original code by Pierre Chretien, updated by Michael Kapler then Lin Crampton and Neeraj Kumar. Source at https://github.com/neeraj5699/time2retire. Comments/complaints to neerajk.bit@gmail.com") 
	), #sidebarPanel
